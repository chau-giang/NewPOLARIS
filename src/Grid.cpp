...
bool CGridBasic::writeSizeParameter(string data_path)
{
    ...
    z_writer << "d\ta_alg\tamaxJB_Lar\tadisr\tmax_adisr\ta_barnet_low_J_lower\ta_barnet_low_J_upper\ta_barnet_high_J_lower\ta_barnet_high_J_upper\ta_dg_lower\ta_dg_upper\ta_dg_10_lower\ta_dg_10_upper\takrat_lowJ_min\takrat_lowJ_max\takrat_highJ_min\takrat_highJ_max"<< endl;
    ...
    while(next(pp))
    {
        ...
        if(!data_pos_akrat_lowJ_min_list.empty())
            akrat_lowJ_min = getMinkRATlowJRadius(pp, 0);

	if(!data_pos_akrat_lowJ_max_list.empty())
            akrat_lowJ_max = getMaxkRATlowJRadius(pp, 0);
            
        if(!data_pos_akrat_highJ_min_list.empty())
            akrat_highJ_min = getMinkRAThighJRadius(pp, 0);
            
        if(!data_pos_akrat_highJ_max_list.empty())
            akrat_highJ_max = getMaxkRAThighJRadius(pp, 0);
        ...
        akrat_lowJ_min << "\t" << akrat_lowJ_max << "\t" << akrat_highJ_min << "\t" << akrat_highJ_max << endl;
    ...
    y_writer << "d\ta_alg\tamaxJB_Lar\tadisr\tmax_adisr\ta_barnet_low_J_lower\ta_barnet_low_J_upper\ta_barnet_high_J_lower\ta_barnet_high_J_upper\ta_dg_lower\ta_dg_upper\ta_dg_10_lower\ta_dg_10_upper\takrat_lowJ_min\takrat_lowJ_max\takrat_highJ_min\takrat_highJ_max"<< endl;
    ...
    x_writer << "d\ta_alg\tamaxJB_Lar\tadisr\tmax_adisr\ta_barnet_low_J_lower\ta_barnet_low_J_upper\ta_barnet_high_J_lower\ta_barnet_high_J_upper\ta_dg_lower\ta_dg_upper\ta_dg_10_lower\ta_dg_10_upper\takrat_lowJ_min\takrat_lowJ_max\takrat_highJ_min\takrat_highJ_max"<< endl;
    while(next(pp))
    {
        double pos = pp->getPosition().X();
        double a_alg = 0;
...
bool CGridBasic::writeMidplaneFits(string data_path, parameters & param, uint bins, bool all, uint loop)
{
    ...
    uint nr_parameters = uint(plt_gas_dens) + uint(plt_dust_dens) + uint(plt_gas_temp) + uint(plt_dust_temp) +
                         ...
                         uint(plt_dg_upper) + uint(plt_dg_10_lower) + uint(plt_dg_10_upper) +  uint(plt_amaxJB_Lar) +
                         uint(plt_abs_ini) + uint(plt_akrat_lowJ_min) + uint(plt_akrat_lowJ_max) + uint(plt_akrat_highJ_min) +
                         uint(plt_akrat_highJ_max);
