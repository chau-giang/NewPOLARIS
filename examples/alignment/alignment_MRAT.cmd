...
#======================================================================
# Calculation of grain alignment by MRAT mechanism - PM grains
#======================================================================
<task> 1
    # Radiation source
    ...
    # Directory to the output folder
	   <path_out>		"directory/to/POLARIS/example/alignment/MRAT/PM/"
    ...
    # Magnetic properties of grains:
     <align>  ALIG_MRAT
     <iron_fraction>   0.1           # Iron fraction inside PM grains
...
#======================================================================
# Calculation of grain alignment by MRAT mechanism - SPM grains
#======================================================================
<task> 1
    # Radiation source
       <source_star nr_photons = "5e4"> 0 0 0   2  6000
    ...
    # Directory to the output folder
       <path_out>       "directory/to/POLARIS/example/alignment/MRAT/SPM_1e4/"
    ...
    # Magnetic properties of grains:
     <align>  ALIG_MRAT
     <number_cluster>    10000          # Number of iron atom/cluster
     <volume_filling_cluster>  0.100    # Volume filling factor of iron clusters inside grains. 
